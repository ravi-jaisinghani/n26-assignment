...
/**
 *  LaunchControlPage: Contains Page objects and actions of  LaunchControlPage
 *
 * @author ravi.jaisinghani
 */

public class LaunchControlPage {
   private AppiumDriver<MobileElement> driver;

   //Locators
   
   @AndroidFindBy(id="com.monefy.app.lite:id/buttonContinue")
   private MobileElement lcpbutton;


   //Constructor
   public LaunchControlPage(AppiumDriver<MobileElement> driver) {
	   this.driver = driver;
